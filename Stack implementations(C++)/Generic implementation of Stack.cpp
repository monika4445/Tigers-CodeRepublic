...
// C++ program for generic implementation of stack
//Underlying container of the Stack can be list, deque or vector
...
void Stack::swap(Stack* other) noexcept {
    m_swap(this->m_list, other->m_list);
